...
function _(x){
	return document.getElementById(x); // Shortcut for Get Element By ID I saw suggested online, didn't find a ton of use, but I already added it
};

function renderQuestion(){ //Renders the question in the Div or says the end of the trivia game
	test = _("test");
	...
	_("test_status").innerHTML = "Question " + (position + 1) + " of " + triviaQuestions.length; //Pulls in question and answers
...
function checkAnswer(){ //Checks if the answer is correct
